   ...
   <section className="relative min-h-[calc(100vh-64px)] flex flex-col items-center justify-center text-white text-center px-4 overflow-hidden bg-gradient-to-b from-black via-indigo-800 to-black">
      ...
      <Particles
        ...
        options={{
          ...
          particles: {
            number: { value: 30 },
          color: { value: ["#ffffff", "#f5f3f4", "#c7d2fe", "#a78bfa", "#f472b6"] },
      ...
      {/* 소개 텍스트 */}
      <h1 className="text-5xl md:text-5xl font-bold mb-2 relative z-10 mb-4">Daejin Kim</h1>
      <p className="text-lg md:text-2xl mt-4 mb-4 relative z-10">
        <span className="text-red-400">Fullstack</span> Developer | <span className="text-red-400">React</span> & <span className="text-red-400">.NET</span> & <span className="text-red-400">Node.js</span> Enthusiast
      </p>
      <p>Northern Alberta Institute of Technology, Digital Media & IT (Computer Software Development)</p>

      {/* 버튼 */}
      <div className="flex space-x-4 relative z-10 mt-5">
        <a href="#skills" className="btn btn-success">My Skills</a>
